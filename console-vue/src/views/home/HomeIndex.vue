  ...
  <div class="common-layout">
    <el-container>
      <el-header height="54px" style="padding: 0">
        <div class="header">
          <div @click="toMySpace" class="logo">🔥SaaS短链接项目@EST-NINE</div>
          <div style="display: flex; align-items: center">
            ...
            <a
              ...
              style="text-decoration: none"
              target="_blank"
              href="https://github.com/EST-NINE/shortlink"
              >代码仓库</a
            >
            <a
              class="link-span"
              style="text-decoration: none"
              target="_blank"
              href="https://github.com/EST-NINE"
              >🔥认识作者</a
            >
            <a
              class="link-span"
              style="text-decoration: none"
              target="_blank"
              href="https://space.bilibili.com/1524312376/bangumi?from_spmid=666.4.mylist.more"
              >EST-NINE</a
            >
            <el-dropdown>
              <div class="block">
