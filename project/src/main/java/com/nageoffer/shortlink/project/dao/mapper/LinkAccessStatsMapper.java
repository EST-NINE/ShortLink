...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    @Insert("INSERT INTO t_link_access_stats (full_short_url, gid, date, pv, uv, uip, hour, weekday, create_time, update_time, del_flag) " +
            "VALUES(#{linkAccessStats.fullShortUrl}, 'siCwZo', #{linkAccessStats.date}, #{linkAccessStats.pv}, #{linkAccessStats.uv}, #{linkAccessStats.uip}, #{linkAccessStats.hour}, #{linkAccessStats.weekday}, NOW(), NOW(), 0) " +
    ...
    @Select("SELECT " +
            ...
            "    AND gid = #{param.gid} " +
            "    AND date BETWEEN  CONCAT(#{startDate},' 00:00:00') and  CONCAT(#{param.endDate},' 23:59:59') " +
            "GROUP BY " +
