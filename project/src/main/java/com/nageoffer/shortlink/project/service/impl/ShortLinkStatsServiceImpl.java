...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        Integer pvCount = listStatsByShortLink.stream().mapToInt(LinkAccessStatsDO::getPv).sum();
        Integer uvCount = listStatsByShortLink.stream().mapToInt(LinkAccessStatsDO::getUv).sum();
        Integer uipCount = listStatsByShortLink.stream().mapToInt(LinkAccessStatsDO::getUip).sum();
